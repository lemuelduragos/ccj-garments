...
function getPaginator($param = null){
...
/// getPaginator Function Mens Start ///


function getPaginatorMens($param = null){
...
echo "<li><a href='mens.php?page=1";
...
echo "<li><a href='mens.php?page=".$i.(!empty($aPath)?'&'.$aPath:'')."' >".$i."</a></li>";

};

echo "<li><a href='mens.php?page=$total_pages";
...
function getPaginatorWomens($param = null){
...
echo "<li><a href='womens.php?page=1";
...
echo "<li><a href='womens.php?page=".$i.(!empty($aPath)?'&'.$aPath:'')."' >".$i."</a></li>";

};

echo "<li><a href='womens.php?page=$total_pages";
