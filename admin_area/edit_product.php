...
$customizable = $row_edit['customizable'];
...
<select required="true" class="form-control" name="customizable"><!-- select manufacturer Starts -->

<option value="">Select if Customizable</option>

<option <?php if ($customizable) {echo "selected";} ?> value="1"> True</option>

<option <?php if (!$customizable) {echo "selected";} ?>  value="2"> False</option>
