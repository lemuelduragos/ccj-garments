...
if(isset($_POST['search'])){
	$query = $_POST['search'];
	$get_c = "select * from customers WHERE customer_name LIKE '%$query%' OR customer_email LIKE '%$query%' OR customer_country LIKE '%$query%' OR customer_city LIKE '%$query%' OR customer_contact LIKE '%$query%'";
} else {
...
<?php 
	if ($type != 3) {
		echo "<td> <a href='index.php?customer_delete=$c_id' >
