...
$check_username = mysqli_num_rows($run_check);
...
$insert_admin = "insert into admins (type, username, admin_name, admin_email,admin_pass,admin_image,admin_contact,admin_country,admin_job,admin_about) values ('$admin_role', '$username', '$admin_name','$admin_email','$admin_pass','$admin_image','$admin_contact','$admin_country','$admin_job','$admin_about')";
