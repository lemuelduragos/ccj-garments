...
<div id=""><!-- mainImage Starts -->


<br><br>

  <div class="pull-left col-30 landing-left">
     <div id="tshirt-div">
      <!-- 
          Initially, the image will have the background tshirt that has transparency
          So we can simply update the color with CSS or JavaScript dinamically
      -->
          <img id="tshirt-backgroundpicture" src="admin_area/product_images/<?php echo $pro_img1; ?>"/>
...
$product_img1 = $_POST['product_custom_img1'];

$filename = time() . '.png';


list($type, $data) = explode(';', $product_img1);
list(, $data)      = explode(',', $product_img1);
$data = base64_decode($data);

file_put_contents("admin_area/product_images/". $filename, $data);


$query = "insert into custom_product (product_img1) values ('$filename')";

$run_query = mysqli_query($db,$query);

$custom_id = mysqli_insert_id($db);
...
$query = "insert into cart (p_id,ip_add,qty,p_price,size, custom_prod_id) values ('$custom_id','$ip_add','$product_qty','$product_price','$product_size', '$custom_id')";
...
<form id="mForm" action="" method="post" class="form-horizontal" ><!-- form-horizontal Starts -->
...
<input id="imageBaseUrl" type="text" name="product_custom_img1" hidden="hidden">
...
<button id="add_cart" class="btn btn-primary" type="submit" name="add_cart">
...
?>
   ...
   <div class="box">   
      <p class="notification">To remove an image or text, select the item and press <b>DELETE</b> key on keyboard.</p>
      <!-- The select that will allow the user to pick one of the static designs -->
      <br>
      <div class="form-group"><!-- form-group Starts -->

      <label class="col-md-5 control-label" >T-Shirt Design </label>
      ...
      <select id="tshirt-design" class="form-control" >
        ...
        <option value="images/logo.png">CCJ Logo</option>
      </select>
      ...
      <label class="col-md-5 control-label" >Upload your own design</label>

      <div class="col-md-7" ><!-- col-md-7 Starts -->

      <input class="input" type="file" id="tshirt-custompicture" />
      ...
      <label class="col-md-5 control-label" >Add Text</label>

      <div class="col-md-7" ><!-- col-md-7 Starts -->

      <input class="input" type="text" id="tshirt-text" />

       <button class="btn-sm btn-primary" id="tshirt-add-text" >Add</button> 
...
<a href='details.php?pro_id=$pro_url' class='btn btn-primary'>
...
<script>
    ...
    function saveTshirt() {
      ...
      domtoimage.toPng(node).then(function (dataUrl) {
          ...
          console.log(dataUrl);
          document.getElementById('imageBaseUrl').value = dataUrl;
    ...
    document.getElementById('tshirt-add-text').addEventListener("click", function(e){
