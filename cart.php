...
$select_cart = "select custom_product.product_img1 AS 'custom_img', cart.* from cart left join custom_product ON custom_product.product_id=cart.custom_prod_id where cart.ip_add='$ip_add'";
...
$custom_img = $row_cart['custom_img'];
